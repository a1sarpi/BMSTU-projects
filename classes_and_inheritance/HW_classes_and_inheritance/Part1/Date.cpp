...
{
	return mDay;     //!!! this тут зачем нужен? Исправил
}

unsigned int Date::getMonth() const
{
	return mMonth;    //!!! this тут зачем нужен? Исправил 
}

unsigned int Date::getYear() const
{
	return mYear;    //!!! this тут зачем нужен? Исправил
}
...
bool Date::operator<(const Date& otherDate)
{
	if (mYear < otherDate.mYear) {    //!!! this тут зачем нужен? ... Исправил 
		return true;
	}
...
Date Date::operator+(const int pDay)
{
	Date result(*this);
	result.mDay += pDay;
